...
module BioPieces
  module Commands
    ...
    # 
    # +sort+ records in the stream given a specific key. Sorting on multiple
    ...
    #
    #    BP.new.read_table(input: "test.tab").sort(key: :COUNT, reverse: true).dump.run
    #    {:COUNT=>4, :ORGANISM=>"Dog"}
    #    {:COUNT=>3, :ORGANISM=>"Cat"}
    #    {:COUNT=>1, :ORGANISM=>"Eel"}
    #
    ...
    #
    #    BP.new.read_table(input: "test.tab").sort(key: :ORGANISM, reverse: true).dump.run
    #    {:COUNT=>1, :ORGANISM=>"Eel"}
    #    {:COUNT=>4, :ORGANISM=>"Dog"}
    #    {:COUNT=>3, :ORGANISM=>"Cat"}
    def sort(options = {})
