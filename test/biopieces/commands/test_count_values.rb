...
class TestCountValues < Test::Unit::TestCase 
  ...
  test "BioPieces::Pipeline#count_values returns correctly" do
    @p.count_values(keys: ["V0", :V1, :FOO]).run(input: @input, output: @output2)

    result   = @input2.map { |h| h.to_s }.reduce(:<<)
    expected = ""
    expected << '{:V0=>"HUMAN", :V1=>"H1", :V0_COUNT=>3, :V1_COUNT=>1}'
    expected << '{:V0=>"HUMAN", :V1=>"H2", :V0_COUNT=>3, :V1_COUNT=>1}'
    expected << '{:V0=>"HUMAN", :V1=>"H3", :V0_COUNT=>3, :V1_COUNT=>1}'
    expected << '{:V0=>"DOG", :V1=>"D1", :V0_COUNT=>2, :V1_COUNT=>1}'
    expected << '{:V0=>"DOG", :V1=>"D2", :V0_COUNT=>2, :V1_COUNT=>1}'
    expected << '{:V0=>"MOUSE", :V1=>"M1", :V0_COUNT=>1, :V1_COUNT=>1}'
