...
class TestWriteTable < Test::Unit::TestCase
  ...
  test 'BioPieces::Pipeline::WriteTable with valid options dont raise' do
  ...
  test 'BioPieces::Pipeline::WriteTable with :skip outputs correctly' do
    result = capture_stdout do
  ...
  test 'BioPieces::Pipeline::WriteTable with :header outputs correctly' do
  ...
  test 'BioPieces::Pipeline::WriteTable with :delimiter outputs correctly' do
    result = capture_stdout do
  ...
  test 'BioPieces::Pipeline::WriteTable w. :delimiter and :pretty raises' do
    assert_raise(BioPieces::OptionError) do
      @p.write_table(delimiter: ';', pretty: true)
    end
  end

  test 'BioPieces::Pipeline::WriteTable with :commify and :pretty raises' do
    assert_raise(BioPieces::OptionError) { @p.write_table(commify: true) }
  end

  test 'BioPieces::Pipeline::WriteTable with :pretty outputs correctly' do
  ...
  test 'BioPieces::Pipeline::WriteTable with :pretty and :header outputs OK' do
    result = capture_stdout do
  ...
  test 'BioPieces::Pipeline::WriteTable w. :pretty and :commify outputs OK' do
    result = capture_stdout do
  ...
  test 'BioPieces::Pipeline::WriteTable w. :pretty and :commify and floats ' \
  ...
  test 'BioPieces::Pipeline::WriteTable with V<num> keys are output OK' do
    input, output   = BioPieces::Stream.pipe
  ...
  test 'BioPieces::Pipeline::WriteTable to file with :first outputs OK' do
  ...
  test 'BioPieces::Pipeline::WriteTable to file with :last outputs correctly' do
  ...
  test 'BioPieces::Pipeline::WriteTable to file with :pretty outputs OK' do
  ...
  test 'BioPieces::Pipeline::WriteTable to file with :pretty and :first ' \
    'outputs correctly' do
  ...
  test 'BioPieces::Pipeline::WriteTable to file with :pretty and :last ' \
    'outputs correctly' do
    @p.write_table(output: @file, pretty: true, header: true,
  ...
  test 'BioPieces::Pipeline::WriteTable to existing file w. :force outputs ' \
    'OK' do
    `touch #{@file}`
  ...
  test 'BioPieces::Pipeline::WriteTable with gzipped data and no output ' \
    ' file raises' do
    assert_raise(BioPieces::OptionError) { @p.write_table(gzip: true) }
  end

  test 'BioPieces::Pipeline::WriteTable with bzip2ed data and no output ' \
    'file raises' do
    assert_raise(BioPieces::OptionError) { @p.write_table(bzip2: true) }
  end

  test 'BioPieces::Pipeline::WriteTable to file outputs gzipped data OK' do
  ...
  test 'BioPieces::Pipeline::WriteTable to file outputs bzip2ed data OK' do
  ...
  test 'BioPieces::Pipeline::WriteTable with both gzip and bzip2 output ' \
    'raises' do
    assert_raise(BioPieces::OptionError) do
